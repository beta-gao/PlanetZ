...
import com.example.planetz.HomePageActivity; // 修改跳转目标为 HomePageActivity
            ...
            auth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "Authentication failed: wrong email address or password", Toast.LENGTH_SHORT).show();
                        }
                    });
        });
