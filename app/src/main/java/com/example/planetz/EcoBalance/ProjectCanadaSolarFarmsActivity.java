...
public class ProjectCanadaSolarFarmsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_canada_solar_farms);
        ...
        // Set project details
        projectTitle.setText("Canada Solar Farms");
        projectDescription.setText("This solar farm project in Canada generates clean energy to power 50,000 homes.");
