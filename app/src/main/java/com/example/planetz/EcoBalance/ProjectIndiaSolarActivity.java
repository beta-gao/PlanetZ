...
public class ProjectIndiaSolarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_india_solar_power_expansion);
        ...
        // Set project details
        projectTitle.setText("India Solar Power Expansion");
        projectDescription.setText("This project in India installs solar panels in rural areas, providing clean energy to communities.");
