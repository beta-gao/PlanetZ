...
public class ProjectKenyaReforestationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_kenya_reforestation);
        ...
        // Set project details
        projectTitle.setText("Kenya Reforestation");
        projectDescription.setText("This reforestation project in Kenya has planted 10,000 trees.");
        projectCost.setText("Cost per ton: $25.00");
        projectImpact.setText("Impact: Offsets 1 ton of CO2e for every $25 contributed.");
        ...
        payButton.setOnClickListener(v -> {
            ...
            try {
                ...
                double cost = co2eAmount * 25; // Calculate total cost
